...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestor de Tareas (To-Do)");

        btnIngresar.setBackground(new java.awt.Color(124, 128, 237));
        ...
        jLabel4.setText("Accede a tu espacio de trabajo");
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        Usuario usuario = repositorio.validarUsuario(username, password);
